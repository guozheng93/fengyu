				    ...
				    <div class="lr-info regist-box">
						...
						<form class="lr-fm regist-fm">
							<div class="input-group f-div">
								  ...
								  <input type="text" class="form-control input-lg user-name" placeholder="请输入手机号" value="">
							</div>
							<div class="f-div">
								<input type="text" placeholder="请输入手机验证码" class="auth-code">
								<input type="button" class="send-ver" value="获取验证码" onclick="settime(this)">
							</div>
						</form>
						<a href="javascript:;" class="btn btn-warning lr-a regist-a">注册</a>
						<div class="third-log">
							<p>使用其他账号登录：</p>
				    ...
				    <div class="lr-info regist-paswd">
						...
						<form class="lr-fm">
							<div class="input-group f-div">
								  ...
								  <input type="password" class="form-control input-lg paswd3p" placeholder="请填写登录密码" value="">
								  <!----为了兼容ie8----->
								  <input type="text" class="form-control input-lg paswd3" placeholder="请填写登录密码" value="">
							</div>
							<div class="input-group f-div">
								  <div class="input-group-addon"><img src="/statics/images/suo.png"></div>
								  <input type="password" class="form-control input-lg paswd4p" placeholder="请重复登录密码" value="">
								  <!----为了兼容ie8----->
						...
						<a href="/view/home/index.jsp" class="btn btn-warning lr-a regist-a">开启蜂娱之旅</a>
						<div class="third-log">
							<p>使用其他账号登录：</p>
							<a href="javascript:;"><img src="/statics/images/qqkuaijie.png"></a>
							<a href="javascript:;"><img src="/statics/images/weixn.png"></a>
        ...
        /*验证码*/
	        ...
	        $(function(){
	        	...
	        	$(".send-ver").popover({
	        		placement:'bottom',
	        		html:true,
	        		content:"<img src='images/fy-bg.png' class='web-tu'><input type='text' placeholder='请输入验证码' value='' class='web-code'>",
	        	})
	        	/**********/
