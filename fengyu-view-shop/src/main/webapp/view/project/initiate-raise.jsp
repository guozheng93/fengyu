...
<form id="crowdfundingInfoForm">
	<div class="warpper1">
		...
		<script type="text/javascript" charset="utf-8" src="/statics/js/lib/jquery-validate/jquery.validate.min.js"></script>
		<script type="text/javascript" charset="utf-8" src="/statics/js/lib/jquery-validate/messages_zh.js"></script>
			...
			<div class="ir-con">
				...
				<div class="ir-info">
					...
					<div class="ir-list">
						...
						<p class="ir-l-p" name="crdfdEntityItem" id="crdfdEntityItemContainer"></p>
					</div>
					<div class="ir-list">
						<span class="ir-l-s">项目名称：</span>
						<input belongTo="crdfdEntity" name="prjtName" type="text" placeholder="不超过20个字" class="pro-name">
					</div>
					<div class="ir-list">
						<span class="ir-l-s no-required">项目简介：</span>
						<input belongTo="crdfdEntity" name="prjtSummary" type="text" placeholder="请简要概述您的项目，长度不超过200个字" class="pro-beif">
						<p class="ir-l-tip">项目简介是会显示在蜂娱众筹首页的~</p>
					</div>
					<div class="ir-list">
						<span class="ir-l-s">筹资金额：</span>
						<div class="raise-amout">
							<input belongTo="crdfdEntity" name="prjtRaiseAmount" type="text" placeholder="整数且不少于100元">
							<span >元</span>
						</div>
					</div>
					<div class="ir-list">
						...
						<div class="raise-amout">
							<input belongTo="crdfdEntity" name="prjtRaiseToplimit" type="text" placeholder="整数且不低于100%">
							<span >%</span>
					...
					<div class="ir-list">
						...
						<div class="raise-amout">
							<input belongTo="crdfdEntity" name="prjtFundCycle" type="text" placeholder="10~60天" style="border-right:1px solid #a9a9a9">
						</div>
					</div>
					...
					<div class="ir-list le-list">
						...
						<div id="crdfdListImageContainer" class="ir-le-tu">
							...
							<div  id="crdfdListImageThumbnail" class="le-tu-show" style="background-image:url(/statics/images//default_tu.png)">
								<img id="testasfs" belongTo="crdfdEntity" name="entityCatalogImage" src="/statics/images/default_tu.png">
							</div>
						</div>
					</div>
					<div class="ir-list le-list">
						...
						<div class="ir-le-tu">
							...
							<div id="crdfdCoverImageThumbnail" class="le-tu-show" style="background-image:url(/statics/images//default_tu.png)">
								<img belongTo="crdfdEntity" name="entityCoverImage" src="/statics/images/default_tu.png">
							</div>
						</div>
					</div>
					<div class="ir-list le-list">
						...
						<div class="ir-le-tu">
							...
							<div name="crdFdDetail" class="edit-txt">
				...
				<div class="ir-info ir-info-2">
					...
					<div class="ir-list">
						...
						<textarea belongTo="crdfdOrganiser" name="orgnrResume" placeholder="向支持者详细介绍你自己或你的团队，并详细说明你与所发起的项目之间的背景，让支持者能够在最短时间内了解你，以拉近彼此之间的距离，不可超过160字。" class="self-introduce"></textarea>
					</div>
					<div class="ir-list">
						<span class="ir-l-s no-required">微博/博客：</span>
						<input belongTo="crdfdOrganiser" name="orgnrBlog" type="text" placeholder="微博/博客地址(选填)" class="pro-beif">
					</div>
					<div class="ir-list">
						<span class="ir-l-s no-required">至支持者的感谢信：</span>
						<textarea belongTo="crdfdOrganiser" name="orgnrBlessWord" class="self-introduce"></textarea>
					</div>
					<div class="ir-list">
						<span class="ir-l-s">联系电话：</span>
						<input belongTo="crdfdOrganiser" name="orgnrTelephone" type="text" placeholder="此信息不会显示在发起人详情页中" class="pro-beif">
					</div>
				</div>
