...
import com.fengyu.common.entity.MainToken;
...
import com.fengyu.common.utils.DateUtils;
import com.fengyu.common.web.jersey.cache.JedisAlterRedisManager;
import com.fengyu.common.web.jersey.security.JwtUtil;
...
public class AuthorizationRequestFilter implements ContainerRequestFilter
{
	...
	private void ckMainToken(String mainTokenText,String cacheKey)
	{
		...
		if (mainTokenText!=null)
		{
			...
			{
				throw new CommonExceptionHandler(HttpStatus.FORBIDDEN,null, CommonExceptionType.FORBIDDEN,null);//拒绝
			}
			//验证上传token是否有效
	...
	private void ckAccessToken(String accessTokenText,String cacheKey){
		...
		if (accessTokenText!=null)
		{
			...
			{
				throw new CommonExceptionHandler(HttpStatus.UNAUTHORIZED,null, CommonExceptionType.UNAUTHORIZED,null);//拒绝
			}else {
